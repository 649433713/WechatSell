...
import wechatorderdemo.sell.service.CategoryService;
import wechatorderdemo.sell.service.ProductService;
import wechatorderdemo.sell.utils.ResultVOUtil;
import wechatorderdemo.sell.vo.ProductInfoVO;
import wechatorderdemo.sell.vo.ProductVO;
...
public class BuyerProductController {
    ...
    public ResultVO list(){
        ...
        List<Integer> categoryTypeList = productInfoList.stream()
                .map(e -> e.getCategory() ).collect(Collectors.toList());
        ...
        for(ProductCategory productCategory:productCategoryList){
            ...
            for (ProductInfo productInfo:productInfoList){
                if (productInfo.getCategory()==productCategory.getCategoryType()){
